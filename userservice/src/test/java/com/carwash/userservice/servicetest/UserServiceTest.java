...
public class UserServiceTest {
    ...
    void testGetUsers(){
        when(userRepository.findAll()).thenReturn(Stream
           .of(new User(100,"max", "maxwell","9148966708","akshay@g.com", "helloo12",  WASHER,true),
             new User(101,"maxi", "maxwell",  "9148966708", "akshay@g.com", "helloo12",  WASHER,true)).collect(Collectors.toList()));
        assertEquals(2, userService.getAllUsers().size());
    }

    @Test
    void testAddUser() {
        UserDto userDto = new UserDto("max", "maxwell", "9148966708", "akshay@gmail.com", "hello123");
        User user = new User();
        user.setUserName("max");
        user.setPhoneNo("9148966708");
